  ...
  try {
    ...
    const [images, total] = await Promise.all([
      prisma.image.findMany({
        ...
        select: {
          ...
          printScore: true,
          aiBestUseCases: true,
          aiNotRecommendedFor: true,
          aiCropSquare: true,
          aiCropPortrait: true,
          aiCropLandscape: true,
          aiTechnicalNotes: true,
          rating: true,
          userTags: true,
          isPinned: true,
    ...
    const transformedImages = images.map((image) => ({
      ...
      classification: {
        ...
        best_use_cases: image.aiBestUseCases || [],
        not_recommended_for: image.aiNotRecommendedFor || [],
        crop_recommendations: {
          square: image.aiCropSquare,
          portrait: image.aiCropPortrait,
          landscape: image.aiCropLandscape,
        },
        technical_notes: image.aiTechnicalNotes,
      },
      platformScores: {
